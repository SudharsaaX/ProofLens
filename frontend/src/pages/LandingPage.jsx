...
export default function LandingPage() {
  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', overflowX: 'hidden', bgcolor: colors.background }}>
      ...
      <Box component="main" sx={{ position: 'relative', zIndex: 10, flexGrow: 1, display: 'flex', flexDirection: 'column', width: '100%', maxWidth: spacing.containerMax, mx: 'auto', px: spacing.gutter, pt: { xs: 8, md: 12 }, pb: 16 }}>
        {/* Hero */}
        <Box component="section" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: 896, mx: 'auto', mb: { xs: 12, md: 16 } }}>
          ...
          <Typography sx={{ ...typography.bodyLg, color: colors.onSurfaceVariant, maxWidth: 576, mx: 'auto', mb: 6 }}>
          ...
          <PrimaryButton variant="hero" onClick={() => navigate('/workspace')} sx={{ px: 8, py: 2, fontSize: '15px' }}>
            Start Free Analysis
          </PrimaryButton>
        </Box>

        {/* Upload Area */}
        <Box component="section" sx={{ width: '100%', maxWidth: 768, mx: 'auto', mb: 16 }}>
          <Box className="animated-border-wrap" sx={{ width: '100%', height: { xs: 300, md: 400 } }}>
        ...
        <Box component="section" id="features" sx={{ width: '100%', mb: 12 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
            <Typography sx={{ ...typography.headlineLg, color: colors.onSurface, letterSpacing: '-0.01em' }}>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, gap: 3 }}>
            ...
            <GlassPanel hover sx={{ p: 4, display: 'flex', flexDirection: 'column', gridColumn: { xs: 'span 1', md: 'span 2' }, position: 'relative', overflow: 'hidden' }}>
              ...
              <Typography sx={{ ...typography.headlineMd, color: colors.onSurface, mb: 1.5 }}>
                {FORENSIC_CARDS[0].title}
              </Typography>
              <Typography sx={{ ...typography.bodyMd, color: colors.onSurfaceVariant, mb: 4, maxWidth: 480 }}>
              ...
              <Box sx={{ bgcolor: colors.surfaceContainer, border: `1px solid ${colors.outlineVariant}20`, borderRadius: radius.default, p: 2, mt: 'auto' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', borderBottom: `1px solid ${colors.outlineVariant}20`, pb: 1, mb: 1 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Typography sx={{ ...typography.codeSm, color: colors.onSurface }}>Sony A7RV [0x4f...9a]</Typography>
                </Box>
              </Box>
            </GlassPanel>
            ...
            <GlassPanel hover sx={{ p: 4, display: 'flex', flexDirection: 'column' }}>
              ...
              <Typography sx={{ ...typography.bodyMd, color: colors.onSurfaceVariant, mb: 4 }}>
              ...
              <Box sx={{ mt: 'auto' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', ...typography.codeSm }}>
            ...
            <GlassPanel hover sx={{ p: 4, display: 'flex', flexDirection: 'column', gridColumn: { xs: 'span 1', md: 'span 1' } }}>
              ...
              <Typography sx={{ ...typography.bodyMd, color: colors.onSurfaceVariant }}>
